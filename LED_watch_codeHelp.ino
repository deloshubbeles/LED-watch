...
Two button LED watch with the aim of having the following functions (^incomplete):
  - Time and day of the week (almost but not quite)
  - Light (4 white LEDs)
  - ^Multi button press functionality
